...
This is an Automatic License Plate Recognition (ALPR) module for [CodeProject.AI Server](https://github.com/codeproject/CodeProject.AI-Server) for the RKNN chipset (eg Orange Pi and Radxa ROCK devices). The actual module itself is downloadable via the CodeProject.AI Server's dashboard.
